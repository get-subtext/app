...
import type { SingleItemStoreLocalSearchApiConfig } from '@get-subtext/lib.local-search.api.single-item-store';
...
export const localSearchStoreConfig: StorageSingleItemStoreConfig = {
