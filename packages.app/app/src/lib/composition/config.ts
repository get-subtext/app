...
import type { SingleItemStoreUserSettingsApiConfig } from '@get-subtext/lib.user-settings.api.single-item-store';
...
export const userSettingsApiConfig: SingleItemStoreUserSettingsApiConfig = {
  myRequestsLimit: 100,
};
...
export const myRequestStoreConfig: StorageSingleItemStoreConfig = {
  key: 'subtext:my-requests',
};
